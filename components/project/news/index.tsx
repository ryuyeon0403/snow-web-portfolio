          ...
          <Stack spacing={"12px"} width={"100%"}>
            <Box className={styles.contentBox}>
              ...
              <Typography
                ...
                sx={{ color: "#000 !important", whiteSpace: "pre-wrap", py: "16px", px: "20px" }}
              >
                새로운 뉴스 플랫폼이 등장했으나{"\n"}사용자는 정보 정착지를 찾지 못했습니다.
              </Typography>
              <Typography
                className={styles.detail4}
                sx={{ color: "#6B6B73 !important", whiteSpace: "pre-wrap", pb: "20px", px: "20px" }}
              >
            ...
            <Box className={styles.contentBox}>
              ...
              <Stack direction={"row"} px={"20px"} spacing={0.5} alignItems={"center"}>
